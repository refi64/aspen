...
class JsAsset extends TextAsset {
  ...
  Future evalAsync() {
    var attr = 'aspen\$js' + (_jsCounter++).toString();
...
@LoadableAsset(url: 'package:aspen_generator/src/default_loaders.dart', loader: 'CssLoader')
class CssAsset extends TextAsset {
  ...
  const CssAsset({String text, this.inline = CssAssetInline.none}): super(text: text);
